...
CREATE TABLE `d_role` (
  ...
  `role_code` varchar(10) COLLATE utf8_bin DEFAULT NULL COMMENT '角色code',
  `description` varchar(45) COLLATE utf8_bin DEFAULT NULL COMMENT '角色描述',
  `state` char(1) COLLATE utf8_bin DEFAULT '1' COMMENT '状态  1 可用 0禁用',
